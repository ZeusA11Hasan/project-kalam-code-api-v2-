...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
    (
        ...
        const splitIntoCharacters = (text: React.ReactNode): React.ReactNode[] => {
        ...
        const elements = useMemo(() => {
            ...
            // If it's a ReactNode array or complex element, we just treat it as a single chunk
        ...
        return (
            <motion.span
                ...
                transition={transition}
            >
                <span className="sr-only">{typeof texts[currentTextIndex] === 'string' ? texts[currentTextIndex] : "Animated text"}</span>
