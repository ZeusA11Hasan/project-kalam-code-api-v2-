                ...
                return (
                    <button
                        ...
                        className={`group flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition-all active:scale-95 ${isActive
                            ...
                            : "border-white/5 bg-white/5 text-white/70 hover:bg-white/10 hover:text-white hover:border-white/10"
                            }`}
                    >
                        <action.icon
                            className={`h-4 w-4 transition-colors ${isActive ? "text-[#99C3C4]" : "text-white/50 group-hover:text-white"
                                }`}
                        />
