...
export const Sidebar: FC<SidebarProps> = ({ contentType, showSidebar }) => {
  ...
  return (
    <TabsContent
      className="m-0 size-full space-y-2"
      style={{
      ...
      value={contentType}
    >
      <div className="glass flex h-full flex-col rounded-r-3xl border-l-0 p-3">
        <div className="flex items-center border-b border-white/15 pb-2">
          <WorkspaceSwitcher />
