...
import { IconX, IconCamera, IconTrash, IconPencil, IconZoomIn, IconZoomOut } from "@tabler/icons-react"
    ...
    return (
        <div className="whiteboard-panel z-[9999] flex h-full flex-col border-l border-gray-200 bg-white shadow-xl">
            ...
            <div className="whiteboard-toolbar flex items-center gap-2 border-b border-gray-200 bg-white p-2">
                <button onClick={handleZoomIn} className="rounded p-2 hover:bg-gray-100" title="Zoom In">
                    <IconZoomIn size={18} />
                </button>
                <button onClick={handleZoomOut} className="rounded p-2 hover:bg-gray-100" title="Zoom Out">
                    <IconZoomOut size={18} />
                </button>
