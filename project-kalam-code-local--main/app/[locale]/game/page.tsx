...
export default function GamePage() {
    return (
        <main className="flex min-h-screen flex-col items-center">
            ...
            <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-20 px-6 py-2 rounded-full border border-white/5 bg-black/20 backdrop-blur-md">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/20 whitespace-nowrap">
