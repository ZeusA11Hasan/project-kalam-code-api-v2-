...
const RAW_SETS = {
  1: [
    {
      question: "What do we call a name that stores a value like x = 5?",
      options: ["function", "variable", "loop", "print"],
      answer: "variable"
    },
    {
  ...
  2: [
    ...
    {
      question: "Choose the correct code to print 'Hello'",
      options: [
        "print Hello",
        "echo('Hello')",
        "print('Hello')",
  ...
  3: [
    {
      ...
      options: ["loop", "range", "while", "print"],
      answer: "range"
    },
    {
      question: "Fix the code (single-line fix):\n\nprint 'Hello'",
      options: ["Add colon", "Add brackets", "Add range", "No change"],
      answer: "Add brackets"
    },
    {
      question: "Fill the missing keyword:\n\n_____ x < 5:\n    print(x)",
      options: ["for", "loop", "while", "if"],
      answer: "while"
    },
    {
      question: "Fix the code:\n\nfor i in range(5)\n    print(i)",
      options: ["Add :", "Add ()", "Add =", "No change"],
      answer: "Add :"
    }
  ]
}
...
const HangmanSVG = ({
  ...
  return (
    ...
    >
      ...
      <motion.g
        animate={isLost ? { rotate: [0, -3, 3, -3, 0] } : {}}
        transition={
          isLost ? { duration: 4, repeat: Infinity, ease: "easeInOut" } : {}
        }
      ...
      >
        {errors >= 4 && (
          <motion.circle
            ...
            cy="65"
            r="15"
            className="fill-white/5 stroke-white"
            strokeWidth="3"
          />
        )}
        {errors >= 5 && (
...
const MinecraftHeart = ({
  ...
  >
    <svg
      viewBox="0 0 9 9"
      className="size-full drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
    >
      <path
        d="M2 1h1v1h1V1h1v1h1V1h1v1h1v3h-1v1h-1v1h-1v1h-1v-1h-1v-1h-1v-1H1V2h1V1z"
        fill="black"
      />
      <path
        d="M2 2h1v2H2V2zm1 0h1v3H3V2zm1 1h1v3H4V3zm1-1h1v3H5V2zm1 0h1v2H6V2z"
        ...
        <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-white/20 to-transparent p-1 shadow-2xl backdrop-blur-3xl">
          <div className="flex flex-col items-center gap-8 rounded-[39px] bg-black/60 p-10">
            <div className="flex flex-col items-center gap-4">
              ...
              <h1 className="font-darker-grotesque px-10 text-center text-6xl font-black uppercase leading-tight tracking-tighter text-white">
                Quantum Engine
              </h1>
            </div>
            <button
              onClick={startNewGame}
              className="group relative rounded-xl bg-white px-12 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-black transition-all hover:scale-105 active:scale-95"
            >
              Initialize Protocol
            </button>
          </div>
      ...
      <div className="mx-auto flex min-h-screen w-full max-w-2xl flex-col items-center justify-center px-6 pb-12 pt-20 text-center">
        <div className="flex w-full flex-col items-center gap-8 rounded-[44px] border border-white/10 bg-black/40 p-8 shadow-2xl backdrop-blur-3xl">
          <div className="flex gap-4">
            {[...Array(6)].map((_, i) => (
              <MinecraftHeart key={i} filled={false} isBreaking={false} />
            ))}
          </div>
          <HangmanSVG errors={6} size={160} />
          <h2 className="font-darker-grotesque text-5xl font-black uppercase leading-none tracking-tight text-[#FF3B30]">
            System Offline
          </h2>
          ...
          <button
            onClick={startNewGame}
            className="flex w-full max-w-xs items-center justify-center gap-3 rounded-xl bg-white py-4 text-[10px] font-black uppercase tracking-widest text-black shadow-xl transition-all hover:bg-neutral-200 active:scale-95"
          >
        ...
        <div className="relative z-10 flex shrink-0 flex-col justify-between gap-6 md:flex-row md:items-end">
          <div className="space-y-3">
            <div className="flex items-center gap-4">
              ...
              <span className="text-[8px] font-black uppercase leading-none tracking-[0.2em] text-white/20">
                Core Interface_v3
              </span>
            </div>
            <h2 className="font-darker-grotesque text-2xl font-black uppercase leading-none tracking-wider text-white">
              Tactical Challenge
            </h2>
          </div>
              ...
              <svg className="absolute inset-0 size-full -rotate-90">
                ...
                <motion.circle
                  ...
                  className={cn(
                    ...
                    timeLeft <= 3 ? "stroke-[#FF3B30]" : "stroke-white/60"
                  )}
                  strokeWidth="4"
                  fill="none"
                  strokeDasharray="157.08"
                  animate={{
                    strokeDashoffset: 157.08 - (157.08 * timeLeft) / 10
                  }}
                />
              </svg>
              <span
                className={cn(
                  ...
                  timeLeft <= 3 ? "text-[#FF3B30]" : "text-white"
                )}
              >
                {timeLeft}
              </span>
              ...
              >
                {currentQ?.shuffledOptions.map(
                  (optText: string, idx: number) => {
                    ...
                    let appearance =
                      "bg-white text-black border-transparent hover:bg-zinc-50 shadow-lg"
                    if (selectedOption) {
                      if (isCorrectValue)
                        appearance =
                          "bg-[#34C759] border-[#34C759] text-white scale-[1.02] shadow-[0_0_20px_rgba(52,199,89,0.2)]"
                      else if (isSel)
                        appearance =
                          "bg-[#FF3B30] border-[#FF3B30] text-white animate-shake shadow-[0_0_20px_rgba(255,59,48,0.2)]"
                      else
                        appearance =
                          "opacity-20 border-transparent grayscale text-black bg-white"
                    }
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          "group flex items-center gap-4 rounded-[24px] border p-5 transition-all duration-300 active:scale-95",
                          appearance
                        )}
                      >
                        <div
                        ...
                        <span className="font-darker-grotesque text-left text-base font-bold normal-case leading-tight tracking-wide">
                          {optText}
                        </span>
                      </button>
                    )
