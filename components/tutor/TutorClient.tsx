...
export default function TutorClient() {
    ...
    async (text: string) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          const errorMsg =
            "I'm here to help! Ask me about Physics, Chemistry, Maths, or Biology."
          setMessages(prev => [
            ...prev,
            {
              id: (Date.now() + 1).toString(),
        ...
        const crashMsg =
          "Welcome! I'm your AI Tutor. Ask me anything about JEE, NEET, or NCERT!"
        setMessages(prev => [
          ...prev,
          {
            id: (Date.now() + 1).toString(),
  ...
  const handleBoardSpeak = useCallback(
    (text: string) => {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto w-full max-w-[680px] pb-[10px]">
        <ChatInput
