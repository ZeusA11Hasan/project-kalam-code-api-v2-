      ...
      <AnimatePresence mode="wait">
        {error && (
          ...
          >
            ...
            <span className="text-xs font-medium leading-relaxed text-red-200">
              {error}
            </span>
          </motion.div>
        )}
        ...
        <AnimatePresence mode="wait">
          {mode === "signup" ? (
            ...
            >
              ...
              <div className="py-2 text-center text-[10px] font-bold uppercase tracking-[4px] text-white/10">
                OR CONNECT
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="flex items-center justify-center rounded-full border-none bg-[#dbdeeb] py-3.5 shadow-[0_10px_30px_rgba(0,0,0,0.3)] transition-all hover:scale-[0.98] active:scale-95"
                >
                  <svg
                    version="1.1"
                ...
                >
                  ...
                  >
                    <path
                      d="M47.1,31.6c-0.1-8.4,6.9-12.4,7.2-12.6c-4-5.8-10.2-6.6-12.4-6.7
