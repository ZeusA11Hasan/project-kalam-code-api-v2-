...
export function FeatureQuickActions({
  voiceMode,
  onToggleVoiceMode,
  onActionSelect
}: FeatureQuickActionsProps) {
      ...
      {actions.map(action => {
        ...
        return (
          <button
            ...
            className={`group flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium transition-all active:scale-95 ${
              isActive
