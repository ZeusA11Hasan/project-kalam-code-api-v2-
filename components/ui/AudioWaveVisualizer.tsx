...
const mediaElementSourceMap = new WeakMap<HTMLAudioElement, MediaElementAudioSourceNode>();
...
export const AudioWaveVisualizer: React.FC<AudioWaveVisualizerProps> = ({
    ...
    return (
        <div className="flex flex-col items-center gap-1">
            ...
            <span className={`text-[8px] font-black uppercase tracking-[0.2em] transition-colors duration-300 ${labelColor}`}>
                {label}
            </span>
        </div>
    );
