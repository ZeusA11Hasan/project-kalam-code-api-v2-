...
export const InteractiveHoverButton: React.FC<InteractiveHoverButtonProps> = ({
  ...
  return (
    <button
      ...
      {...props}
    >
      <span className="absolute size-0 rounded-full bg-orange-600 opacity-10 transition-all duration-500 ease-out group-hover:size-56"></span>
      ...
      <span className="absolute inset-0 -mt-1 size-full rounded-lg bg-gradient-to-b from-transparent via-transparent to-gray-200 opacity-30"></span>
