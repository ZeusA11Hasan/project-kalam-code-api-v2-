                ...
                <>
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between border-b border-white/5 px-6 py-5">
                            ...
                            <button onClick={onClose} className="rounded-full p-1.5 text-white/30 transition-colors hover:bg-white/5 hover:text-white/60">
                                <X className="size-4" />
                            </button>
                        </div>
                        ...
                        <div className="custom-scrollbar-thin max-h-[460px] space-y-6 overflow-y-auto px-2 py-4">
                            ...
                            <div className="space-y-3">
                                ...
                                {onlineUsers.length === 0 ? (
                                    <p className="px-4 text-[13px] italic text-white/20">No one is online right now.</p>
                                ) : (
    ...
    return (
        ...
        >
            ...
            <div className="relative shrink-0">
                <div className={`size-11 overflow-hidden rounded-full border border-white/10 p-0.5 transition-all duration-300 ${isOnline ? 'ring-2 ring-cyan-500/20' : ''}`}>
            ...
            <div className="min-w-0 flex-1">
                <div className="flex flex-col">
                    <span className="truncate text-[14px] font-semibold text-white/90">{profile.name}</span>
                    <span className="truncate text-[12px] text-white/40">{profile.bio}</span>
                </div>
            </div>
