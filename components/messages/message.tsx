  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-3">
          ...
          message.role === "assistant" ? (
            <>
              {(() => {
                switch (toolInUse) {
                  ...
                  case "retrieval":
                    return (
                      <div className="flex animate-pulse items-center space-x-2 text-purple-300">
            ...
            <TextareaAutosize
              ...
              className="text-md rounded-lg border border-white/10 bg-black/20 p-2 text-white focus:ring-2 focus:ring-purple-500"
              value={editedMessage}
        ...
        {fileItems.length > 0 && (
          <div className="mt-6 border-t border-white/10 pt-4 font-bold text-white/80">
            {!viewSources ? (
              <div
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          {message.image_paths.map((path, index) => {
            ...
            return (
              <Image
                key={index}
                className="cursor-pointer rounded border-2 border-white/10 hover:opacity-50"
