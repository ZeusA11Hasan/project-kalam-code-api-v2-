...
export default function InfiniteCanvas({
    ...
    return (
        <div
            ref={viewportRef}
            className={`whiteboard-viewport touch-none select-none bg-[#1a1a1a] ${className}`}
            style={{
                width: '100%',
                height: '100%',
                overflow: 'hidden',
        ...
        >
            ...
            >
                ...
                <div
                    className="whiteboard-grid pointer-events-none absolute"
                    style={{
                        width: '200000px',
                        height: '200000px',
                        left: '-100000px',
            ...
            <div className="pointer-events-auto absolute bottom-6 right-6 z-50 flex flex-col gap-2">
                <div className="flex flex-col gap-2 rounded-full border border-white/10 bg-[#1e1e1e]/90 p-2 shadow-2xl backdrop-blur-md">
                    <button
